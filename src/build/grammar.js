...
var grammar = {
    ...
    {"name": "container$ebnf$3", "symbols": []},
    {"name": "container$ebnf$3", "symbols": ["container$ebnf$3", "_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "container", "symbols": ["container$ebnf$1", "sized_container", "container$ebnf$2", (lexer.has("colon") ? {type: "colon"} : colon), "container$ebnf$3", "integer"], "postprocess": d => { d[1].repetition = d[5]; return d[1]; }},
    {"name": "container$ebnf$4", "symbols": []},
    {"name": "container$ebnf$4", "symbols": ["container$ebnf$4", "_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "container$ebnf$5", "symbols": []},
    {"name": "container$ebnf$5", "symbols": ["container$ebnf$5", "_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "container$ebnf$6", "symbols": []},
    {"name": "container$ebnf$6", "symbols": ["container$ebnf$6", "_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "container", "symbols": ["container$ebnf$4", "unsized_container", "container$ebnf$5", (lexer.has("colon") ? {type: "colon"} : colon), "container$ebnf$6", "integer"], "postprocess": d => { d[1].repetition = d[5]; return d[1]; }},
    {"name": "container$ebnf$7", "symbols": []},
    {"name": "container$ebnf$7", "symbols": ["container$ebnf$7", "_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "container", "symbols": ["container$ebnf$7", "sized_container"], "postprocess": d => d[1]},
    {"name": "container$ebnf$8", "symbols": []},
    {"name": "container$ebnf$8", "symbols": ["container$ebnf$8", "_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "container", "symbols": ["container$ebnf$8", "unsized_container"], "postprocess": d => d[1]},
