...
var grammar = {
    ...
    {"name": "container_list_or_subdivisions", "symbols": ["container_list_or_subdivisions$ebnf$1", "subdivisions"], "postprocess": d => { return [{ type: "blond", dimension: undefined, subdivisions: d[1] }] }},
    ...
    {"name": "sized_container", "symbols": ["sized_contents", "sized_container$ebnf$1", "subdivisions"], "postprocess": d => { return { type: "B", dimension: d[0].dimension, subdivisions: d[2] }}},
    ...
    {"name": "sized_contents_with_subcontainers", "symbols": [(lexer.has("ls") ? {type: "ls"} : ls), "sized_contents_with_subcontainers$ebnf$1", "dimension", "sized_contents_with_subcontainers$ebnf$2", "sized_contents_with_subcontainers$ebnf$3", (lexer.has("rs") ? {type: "rs"} : rs)], "postprocess": d => { return { type: "SCWC", dimension: d[2], contents: d[3] }}},
