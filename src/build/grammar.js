...
var grammar = {
    ...
    {"name": "sized_contents$ebnf$3", "symbols": ["_"], "postprocess": id},
    {"name": "sized_contents$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "sized_contents$ebnf$4", "symbols": ["_"], "postprocess": id},
    {"name": "sized_contents$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "sized_contents$ebnf$5", "symbols": ["_"], "postprocess": id},
    {"name": "sized_contents$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "sized_contents_with_subcontainers$ebnf$2", "symbols": ["_"], "postprocess": id},
    ...
    {"name": "unsized_contents$ebnf$2", "symbols": ["_"], "postprocess": id},
    {"name": "unsized_contents$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "unsized_contents$ebnf$3", "symbols": ["_"], "postprocess": id},
    {"name": "unsized_contents$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
