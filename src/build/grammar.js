...
var grammar = {
    ...
    {"name": "subdivisions$ebnf$6", "symbols": ["_"], "postprocess": id},
    {"name": "subdivisions$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subdivisions$ebnf$7", "symbols": ["ranged_container_list"], "postprocess": id},
    {"name": "subdivisions$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subdivisions$ebnf$8", "symbols": ["_"], "postprocess": id},
    {"name": "subdivisions$ebnf$8", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subdivisions", "symbols": [(lexer.has("lb") ? {type: "lb"} : lb), "subdivisions$ebnf$6", "rotation", "subdivisions$ebnf$7", "subdivisions$ebnf$8", (lexer.has("rb") ? {type: "rb"} : rb)], "postprocess": d => {return { division: 1, rotation: d[2], ranges: d[3] }}},
    {"name": "subdivisions$ebnf$9", "symbols": ["_"], "postprocess": id},
    {"name": "subdivisions$ebnf$9", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subdivisions$ebnf$10", "symbols": ["_"], "postprocess": id},
    {"name": "subdivisions$ebnf$10", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subdivisions$ebnf$11", "symbols": ["ranged_container_list"], "postprocess": id},
    {"name": "subdivisions$ebnf$11", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subdivisions$ebnf$12", "symbols": ["_"], "postprocess": id},
    {"name": "subdivisions$ebnf$12", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subdivisions", "symbols": [(lexer.has("lb") ? {type: "lb"} : lb), "subdivisions$ebnf$9", "integer", "subdivisions$ebnf$10", "rotation", "subdivisions$ebnf$11", "subdivisions$ebnf$12", (lexer.has("rb") ? {type: "rb"} : rb)], "postprocess": d => {return { division: d[2], rotation: d[4], ranges: d[5] }}},
    {"name": "rotation$ebnf$1", "symbols": ["_"], "postprocess": id},
    {"name": "rotation$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "rotation", "symbols": [(lexer.has("lt") ? {type: "lt"} : lt), "rotation$ebnf$1", "ratio"], "postprocess": d => d[2].mul(-1)},
    {"name": "rotation$ebnf$2", "symbols": ["_"], "postprocess": id},
    {"name": "rotation$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
