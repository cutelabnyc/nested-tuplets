...
var grammar = {
    ...
    {"name": "nestup$ebnf$1", "symbols": ["nestup$ebnf$1", "container"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "sized_container", "symbols": ["sized_contents_with_subcontainers"]},
    ...
    {"name": "unsized_container", "symbols": ["unsized_contents_with_subcontainers"]},
    ...
    {"name": "unsized_container", "symbols": ["subdivisions"], "postprocess": d => { return { dimension: undefined, subdivisions: d[0] }}},
    ...
    {"name": "sized_contents_with_subcontainers$ebnf$2", "symbols": ["container"]},
    {"name": "sized_contents_with_subcontainers$ebnf$2", "symbols": ["sized_contents_with_subcontainers$ebnf$2", "container"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "unsized_contents_with_subcontainers$ebnf$1", "symbols": ["container"]},
    {"name": "unsized_contents_with_subcontainers$ebnf$1", "symbols": ["unsized_contents_with_subcontainers$ebnf$1", "container"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "unsized_contents_with_subcontainers$ebnf$2", "symbols": ["_"], "postprocess": id},
    {"name": "unsized_contents_with_subcontainers$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "unsized_contents_with_subcontainers", "symbols": [(lexer.has("ls") ? {type: "ls"} : ls), "unsized_contents_with_subcontainers$ebnf$1", "unsized_contents_with_subcontainers$ebnf$2", (lexer.has("rs") ? {type: "rs"} : rs)], "postprocess": d => { return { dimension: undefined, contents: d[1] }}},
    ...
    {"name": "subdivisions$ebnf$1", "symbols": ["subdivisions$ebnf$1", "ranged_container"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "subdivisions$ebnf$4", "symbols": ["subdivisions$ebnf$4", "ranged_container"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
